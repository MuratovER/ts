...
# Проект TopSkills
Платформа геймифированного личностного развития, основанная на книге Альберта Харисовича "Уроки лидерства".
В платформе используются подходы MMORPG в реальной жизни. 
